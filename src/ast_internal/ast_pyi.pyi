...
if sys.version_info >= (3, 13):
    from _ast_pyi import PyCF_OPTIMIZED_AST as PyCF_OPTIMIZED_AST
...
if sys.version_info >= (3, 10):
    ...
    class match_case(AST):
        ...
        pattern: ast_py.pattern
        guard: expr | None
        body: list[stmt]
        if sys.version_info >= (3, 13):
            def __init__(self, pattern: ast_py.pattern, guard: expr | None = None, body: list[stmt] = ...) -> None: ...
        elif sys.version_info >= (3, 10):
            @overload
            def __init__(self, pattern: ast_py.pattern, guard: expr | None, body: list[stmt]) -> None: ...
            @overload
            def __init__(self, pattern: ast_py.pattern, guard: expr | None = None, *, body: list[stmt]) -> None: ...

        if sys.version_info >= (3, 14):
            def __replace__(self, *, pattern: ast_py.pattern = ..., guard: expr | None = ..., body: list[stmt] = ...) -> Self: ...
    ...
    class MatchAs(pattern):
        ...
        pattern: ast_py.pattern | None # pyright: ignore[reportInvalidTypeForm]
        name: str | None
        def __init__(
            self, pattern: ast_py.pattern | None = None, name: str | None = None, **kwargs: Unpack[_Attributes[int]] # pyright: ignore[reportInvalidTypeForm]
        ) -> None: ...

        if sys.version_info >= (3, 14):
            def __replace__(
                self, *, pattern: ast_py.pattern | None = ..., name: str | None = ..., **kwargs: Unpack[_Attributes[int]] # pyright: ignore[reportInvalidTypeForm]
            ) -> Self: ...
